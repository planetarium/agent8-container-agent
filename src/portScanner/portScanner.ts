...
import type { CandidatePort, PortMonitorEvents, PortScannerOptions } from "./types.ts";
import { MovingAverage, detectListeningPorts } from "./utils/platform.ts";
      ...
      const scanPorts = async () => {
        ...
        try {
          ...
          if (this.options.enableLogging) {
            console.debug(`[PortScanner] Scan delay: ${this.scanDelay}ms`);
          }
